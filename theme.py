...
/* Riga piccola sotto all'etichetta: quale gara ha prodotto quel numero. */
.kpi-sub  { font-family:'Barlow Condensed',sans-serif; font-size:11px;
            color:var(--muted); line-height:1.25; margin-top:2px;
            overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
a.kpi-link { display:block; text-decoration:none; color:inherit; }
a.kpi-link .kpi-wrap { transition: border-color .15s, background .15s; }
a.kpi-link:hover .kpi-wrap { border-color:var(--teal); background:var(--glass2); }
a.kpi-link:hover .kpi-sub { color:var(--sky); }
...
/* ── Classifiche ──
   Sotto al nome ci stanno data e manifestazione: riga piccola, una sola,
   troncata con i puntini quando il nome della gara e' lungo. */
.cl-nome { color:var(--white); font-weight:600; font-size:14px; line-height:1.2; }
.cl-sotto { padding:0 4px 9px; border-bottom:1px solid var(--hairline); }
.cl-meta { font-size:11px; color:var(--muted); line-height:1.3;
           overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
